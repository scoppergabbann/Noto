-- =============================================================
-- Lumen — Database schema (PostgreSQL / Supabase)
...
create table if not exists gold_assets (
  ...
  current_price_per_gram numeric(15,2),
  notes         text,
  created_at    timestamptz default now()
);
...
-- ---------- TRANSACTIONS (untuk Summary / cashflow) ----------
...
-- Policy generik: user hanya akses baris miliknya.
-- (Ulangi pola ini per tabel.)
do $$
declare t text;
begin
